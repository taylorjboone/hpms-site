...
class PbiEmbedService:
    ...
    def get_embed_params_for_single_report(self, workspace_id, report_id, additional_dataset_id=None):
        ...
        report_url = f'https://api.powerbigov.us/v1.0/myorg/groups/{workspace_id}/reports/{report_id}'       
    ...
    def get_embed_token_for_single_report_single_workspace(self, report_id, dataset_ids, target_workspace_id=None):
        ...
        embed_token_api = 'https://api.powerbigov.us/v1.0/myorg/GenerateToken'
    ...
    def get_request_header(self):
        ...
        return {'Content-Type': 'application/json', 'Authorization': 'Bearer ' + aadservice.AadService.get_access_token()}